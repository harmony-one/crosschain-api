...
exports.ethToOneErc20 = void 0;
const interfaces_1 = require("../interfaces");
const logs_1 = require("../utils/logs");
const operation_helpers_1 = require("../operation-helpers");
const utils_1 = require("../utils");
exports.ethToOneErc20 = async (api, operationParams, ethMethods, hmyMethods, prefix, maxWaitingTime) => {
    ...
    if (approveEthManger && approveEthManger.status === interfaces_1.STATUS.WAITING) {
        ...
        const res = await ethMethods.approveEthManger(erc20Address, amount, erc20TokenDetails.decimals, (hash) => operation_helpers_1.confirmCallback(api, hash, approveEthManger.type, operationParams.id));
    ...
    if (lockToken && lockToken.status === interfaces_1.STATUS.WAITING) {
        ...
        const res = await ethMethods.lockToken(operationParams.erc20Address, operationParams.oneAddress, operationParams.amount, erc20TokenDetails.decimals, (hash) => operation_helpers_1.confirmCallback(api, hash, lockToken.type, operationParams.id));
        logs_1.logger.info({ prefix, message: 'Status: ' + (res ? res.status : '') });
